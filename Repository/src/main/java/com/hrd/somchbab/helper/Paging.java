...
public class Paging {
    ...
    private int endPage;
    public static int limitStatic = 10;
    private int offset;

    public Paging() {
        this(1, limitStatic, 0, 0, 5);
    }
    ...
    public String toString() {
        return "Paging [page=" + page + ", limit=" + limit + ", nextPage=" + nextPage + ", previousPage=" + previousPage
                + ", totalCount=" + totalCount + ", totalPages=" + totalPages + ", pagesToShow=" + pagesToShow
                + ", startPage=" + startPage + ", endPage=" + endPage + ", offset=" + offset + "]";
    }
}
